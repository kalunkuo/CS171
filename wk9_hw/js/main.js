...
function initMainPage(dataArray) {
    ...
    // TODO - init bars
    myBarVisOne = new BarVis('barDiv', dataArray[1], dataArray[2],true, "Top Ten States: ");
    myBarVisTwo = new BarVis('barTwoDiv', dataArray[1], dataArray[2],false, "Lowest Ten States: ");
...
function categoryChange() {
    ...
    // maybe you need to change this slightly depending on the name of your MapVis instance
